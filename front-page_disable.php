...
<section class="wrapper bg-dark angled lower-start">
      ...
      <div class="container pt-19 pt-md-21 pb-16 pb-md-18">
        ...
        <div class="row gy-10 gy-sm-13 gx-lg-3 mb-16 mb-md-18 align-items-center">
          <div class="col-md-8 col-lg-6 position-relative">
            ...
            <figure class="rounded"><img src="<?php echo get_template_directory_uri(); ?>/dist/img/photos/about7.jpg" srcset="<?php echo get_template_directory_uri(); ?>/dist/img/photos/about7@2x.jpg 2x" alt="" /></figure>
          </div>
          <!--/column -->
        ...
        <div class="row gy-10 gy-sm-13 gx-lg-3 align-items-center">
          <div class="col-md-8 col-lg-6 offset-lg-1 order-lg-2 position-relative">
            ...
            <figure class="rounded"><img src="<?php echo get_template_directory_uri(); ?>/dist/img/photos/about9.jpg" srcset="<?php echo get_template_directory_uri(); ?>/dist/img/photos/about9@2x.jpg 2x" alt=""></figure>
          </div>
          <!--/column -->
          <div class="col-lg-5">
    ...
    <!-- /section -->
    <section class="wrapper image-wrapper bg-image bg-overlay" data-image-src="<?php echo get_template_directory_uri(); ?>/dist/img/photos/bg1.jpg">
          ...
          <div class="swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <article>
                  <figure class="overlay overlay-1 hover-scale rounded mb-6"><a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/dist/img/photos/b4.jpg" alt="" /></a>
                    <figcaption>
              ...
              <div class="swiper-slide">
                <article>
                  <figure class="overlay overlay-1 hover-scale rounded mb-6"><a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/dist/img/photos/b5.jpg" alt="" /></a>
                    <figcaption>
                      <h5 class="from-top mb-0">Read More</h5>
                    </figcaption>
                  </figure>
              ...
              <div class="swiper-slide">
                <article>
                  <figure class="overlay overlay-1 hover-scale rounded mb-6"><a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/dist/img/photos/b6.jpg" alt="" /></a>
                    <figcaption>
                      <h5 class="from-top mb-0">Read More</h5>
                    </figcaption>
                  </figure>
              ...
              <div class="swiper-slide">
                <article>
                  <figure class="overlay overlay-1 hover-scale rounded mb-6"><a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/dist/img/photos/b7.jpg" alt="" /></a>
                    <figcaption>
                      <h5 class="from-top mb-0">Read More</h5>
                    </figcaption>
                  </figure>
      ...
      <div class="container py-16 py-md-18 position-relative">
        ...
        <div class="row gy-10 gy-sm-13 gx-lg-3 align-items-center">
          <div class="col-md-8 col-lg-6 position-relative">
            <div class="shape bg-dot primary rellax w-17 h-21" data-rellax-speed="1" style="top: -2rem; left: -1.9rem;"></div>
            <div class="shape rounded bg-soft-primary rellax d-md-block" data-rellax-speed="0" style="bottom: -1.8rem; right: -1.5rem; width: 85%; height: 90%; "></div>
            <figure class="rounded"><img src="<?php echo get_template_directory_uri(); ?>/dist/img/photos/about14.jpg" srcset="<?php echo get_template_directory_uri(); ?>/dist/img/photos/about14@2x.jpg 2x" alt="" /></figure>
          </div>
          <!--/column -->
          <div class="col-lg-5 col-xl-4 offset-lg-1">
