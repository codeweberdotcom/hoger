...
function CPT_Projects_Settings($wp_customize)
{
   ...
   $wp_customize->add_setting(
      'codeweber_header_project_style',
      array(
         'default' => 'default',
      )
   );
   ...
   $wp_customize->add_control(
      ...
      array(
         'type' => 'radio',
         'label' => esc_html__('Style Project Header', 'codeweber'),
         'section' => 'project-section',
         'choices' => array(
   ...
   $wp_customize->add_setting(
      'codeweber_header_project_color',
      array(
         'default' => 'default',
      )
   );
   ...
   $wp_customize->add_setting(
      'codeweber_header_project_bread',
      array(
         'default' => 'default',
      )
   );
   ...
   $wp_customize->add_setting(
      'codeweber_header_project_angle',
      array(
         'default' => 'default',
      )
   );
   ...
   $wp_customize->add_setting(
      'codeweber_header_project_bread_color',
      array(
         'default' => 'default',
      )
   );
   ...
   $wp_customize->add_setting(
      'codeweber_page_project_header_bg',
      array(
         'default'   => 'light',
      )
   );
   ...
   // Image Background Projects Page Header
   $wp_customize->add_setting('image_control_three', array(
      'default' => '',
      'type' => 'theme_mod',
      'capability' => 'edit_theme_options',
   ));
   ...
   $wp_customize->add_control(
      new WP_Customize_Image_Control($wp_customize, 'image_control_three', array(
         'label' => __('Page Header Projects Background', 'codeweber'),
         'section' => 'project-section',
         'settings' => 'image_control_three',
      ))
   );
}

add_action('customize_register', 'CPT_Projects_Settings');
