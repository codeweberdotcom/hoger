            ...
            <div class="d-flex mb-4 mb-lg-0">
               <div>
                  <?php if (get_sub_field('phone') == 'Option page') : ?>
                     <a class="text-dark fs-22 hover link-body d-flex" href="tel:<?php echo esc_attr($phone); ?>"><i class="uil uil-phone-volume me-2"></i><?php echo esc_html($phone); ?></a>
                  <?php elseif (get_sub_field('phone') == 'Custom') : ?>
                     <a class="text-dark fs-22 hover link-body d-flex" href="tel:<?php the_sub_field('custom_phone'); ?>"><i class="uil uil-phone-volume me-2"></i><?php the_sub_field('custom_phone'); ?></a>
                  <?php endif; ?>
