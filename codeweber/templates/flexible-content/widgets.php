...
/**
 * Block template file: templates/flexible-content/widgets.php
 *
 * Widgets Block Template.
 *
...
<?php if (have_rows('widgets')) : ?>
   <?php while (have_rows('widgets')) : the_row(); ?>
      ...
      <?php $layout_path = 'templates/flexible-content/widgets/' . $layout . '/' . $layout; ?>
