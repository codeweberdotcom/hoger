...
$block = new CW_Settings(
   $cw_settings = array(
      ...
      'swiper' => array(
         ...
         'image_demo' => ' <figure><img class="w-auto" src="' . get_template_directory_uri() . '/dist/img/illustrations/i3.png" srcset="./assets/img/illustrations/i3@2x.png 2x" alt="" /></figure>',
         'image_big_size' => 'project_1',
         'img_link' => '/dist/img/illustrations/i3.png',
         'data_margin' => '30',
         'nav' => 'true',
         'nav_color' => 'nav-light',
