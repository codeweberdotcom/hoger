...
$block = new CW_Settings(
   $cw_settings = array(
      ...
      'swiper' => array(
         ...
         'image_thumb_size' => 'testimonial_8',
      ...
      'shapes' => array('<div class="shape rounded-circle bg-soft-primary rellax w-21 h-21" data-rellax-speed="1" style="top: 7rem; left: 1rem"></div>'),
...
<section id="<?php echo esc_html($args['block_id']); ?>" class="<?php echo $block->section_class; ?> <?php echo esc_html($args['block_class']); ?>" <?php echo $block->background_data; ?>>
   <div class="container py-14 py-lg-16 pb-lg-0">
      <div class="row gx-lg-8 gx-xl-0 align-items-center">
         <div class="col-lg-5 col-xl-4 offset-xl-1 d-none d-lg-flex position-relative <?php echo $block->column_class_1; ?>">
         ...
         <!--/column -->
         <div class="col-lg-6 col-xl-6 col-xxl-5 offset-xl-1 <?php echo $block->column_class_2; ?>">
            <?php
                              ...
                              while (have_rows('testimonials_post_field', $post_id)) : the_row();
                                 if (get_sub_field('status') == 1) {
                                    ...
                                    if (get_sub_field('testimonial')) {
                                       $testimonial = ReadMore(get_sub_field('testimonial'), $link, 180);
                                    } else {
                                       $testimonial = NULL;
                                    }
