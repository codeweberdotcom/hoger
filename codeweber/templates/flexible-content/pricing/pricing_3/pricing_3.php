 <?php
   ...
   $block = new CW_Settings(
      $cw_settings = array(
         ...
         'title' => 'Our Pricing',
         'patternTitle' => '<h2 class="display-5 mb-7 text-center %2$s">%1$s</h2>',
                         ...
                         <?php while (have_rows('cw_price_packages', $price_package)) : the_row(); ?>
                            ...
                            <?php if (have_rows('package_price', $post_id)) : ?>
                               <?php while (have_rows('package_price', $post_id)) : the_row(); ?>
                                  ...
                                  <div class="col-md-6 col-lg-3 <?php if ($popular == true) {
                                                                     echo 'popular';
                                                                  }; ?>">
                                     <div class="pricing card shadow-none <?php if ($popular == true) {
