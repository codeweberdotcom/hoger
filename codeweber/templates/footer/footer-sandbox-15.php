     ...
     <div class="container py-13 py-md-15">
        <div class="row gy-6 gy-lg-0">
           ...
           <div class="col-md-4 col-lg-2 offset-lg-2">
              <div class="widget">
                 <h4 class="widget-title display-6 fs-18 mb-3 text-white"><?php esc_html_e('Need Help?', 'codeweber'); ?></h4>
           ...
           <div class="col-md-4 col-lg-2">
              <div class="widget">
                 <h4 class="widget-title display-6 fs-18 mb-3 text-white"><?php esc_html_e('Learn More', 'codeweber'); ?></h4>
           ...
           <div class="col-md-4 col-lg-2">
              <div class="widget">
                 <h4 class="widget-title display-6 fs-18 mb-3 text-white"><?php esc_html_e('Get in Touch ', 'codeweber'); ?></h4>
