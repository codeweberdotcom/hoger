              ...
              <div class="container">
                 <div class="row text-center">
                    <div class="col-xl-11 col-xxl-9 mx-auto">
                       <h2 class="fs-16 text-uppercase text-gradient gradient-1 mb-3"><?php esc_html_e('Join Our Community', 'codeweber'); ?></h2>
                       <h3 class="display-4 mb-7 px-lg-17"><?php esc_html_e('We are trusted by over 5000+ clients. Join them now and grow your business.', 'codeweber'); ?></h3>
                    </div>
                    <!-- /column -->
                 </div>
                 <!-- /.row -->
                 <div class="d-flex justify-content-center">
                    <span><a class="btn btn-lg btn-gradient gradient-1 rounded"><?php esc_html_e('Get Started', 'codeweber'); ?></a></span>
                 </div>
              </div>
              <!--/.container -->
           </div>
                    ...
                    <form action="https://elemisfreebies.us20.list-manage.com/subscribe/post?u=aa4947f70a475ce162057838d&amp;id=b49ef47a9a" method="post" id="mc-embedded-subscribe-form2" name="mc-embedded-subscribe-form" class="validate " target="_blank" novalidate>
                       <div id="mc_embed_signup_scroll2">
                          <div class="mc-field-group input-group form-floating">
                             ...
                             <input type="submit" value="Join" name="subscribe" id="mc-embedded-subscribe2" class="btn btn-primary <?php echo GetThemeButton(); ?>btn-gradient gradient-1">
                          </div>
