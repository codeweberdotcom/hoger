  <footer class="bg-gray">
     <div class="container py-13 py-md-15">
        <div class="d-lg-flex flex-row align-items-lg-center">
           <h3 class="display-3 ls-sm mb-6 mb-lg-0 pe-lg-20 pe-xl-22 pe-xxl-25"><?php esc_html_e('Join our community by using our services and grow your business.', 'codeweber'); ?></h3>
           <a href="#" class="btn btn-lg btn-primary rounded mb-0 text-nowrap"><?php esc_html_e('Try It For Free', 'codeweber'); ?></a>
        </div>
        <!--/div -->
        ...
        <div class="row gy-6 gy-lg-0">
           ...
           <div class="col-md-4 col-lg-3">
              <div class="widget">
                 <h4 class="widget-title display-6 fs-20  ls-sm mb-3"><?php esc_html_e('Get in Touch ', 'codeweber'); ?></h4>
           ...
           <div class="col-md-4 col-lg-3">
              <div class="widget">
                 <h4 class="widget-title display-6 fs-20  ls-sm mb-3"><?php esc_html_e('Learn More', 'codeweber'); ?></h4>
           ...
           <div class="col-md-12 col-lg-3">
              <div class="widget">
                 <h4 class="widget-title display-6 fs-20  ls-sm mb-3"><?php esc_html_e('Our Newsletter', 'codeweber'); ?></h4>
