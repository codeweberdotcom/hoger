    <footer class="bg-dark section-frame">
       <div class="container pb-13 pb-md-15">
          <div class="card image-wrapper bg-full bg-image bg-overlay mt-n50p mx-md-5" data-image-src="<?php echo get_template_directory_uri(); ?>./dist/img/photos/bg27.jpg">
             <div class="card-body p-6 p-md-11 d-lg-flex flex-row align-items-lg-center justify-content-md-between text-center text-lg-start">
                <h3 class="display-4 mb-6 mb-lg-0 pe-lg-10 pe-xl-5 pe-xxl-18 text-white"><?php esc_html_e('We are trusted by over 5000+ clients. Join them by using our services and grow your business.', 'codeweber'); ?></h3>
                <a href="#" class="btn btn-lg btn-white rounded mb-0 text-nowrap"><?php esc_html_e('Join Us', 'codeweber'); ?></a>
             </div>
             <!--/.card-body -->
          </div>
          <!--/.card -->
          <div class="text-inverse mx-md-5 mt-n15 mt-lg-0">
             <div class="row gy-6 gy-lg-0">
                ...
                <div class="col-md-4 col-lg-3">
                   <div class="widget">
                      <h4 class="widget-title display-6 fs-18 text-white mb-3"><?php esc_html_e('Get in Touch ', 'codeweber'); ?></h4>
                ...
                <div class="col-md-12 col-lg-3">
                   <div class="widget">
                      <h4 class="widget-title display-6 fs-18 text-white mb-3"><?php esc_html_e('Our Newsletter', 'codeweber'); ?></h4>
